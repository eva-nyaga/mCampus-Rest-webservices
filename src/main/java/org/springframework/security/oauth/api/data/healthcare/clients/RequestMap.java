...
public class RequestMap {
	 ...
	 private String[] DBParams;
	  ...
	  public RequestMap(String q, String customerid, String country, int startindex,
	  ...
	  public RequestMap(String customerid, String country, int startindex,
			int maxresults, int status, String restrict, String orderby) {
	  ...
	  public RequestMap(String customerid, String country) {
