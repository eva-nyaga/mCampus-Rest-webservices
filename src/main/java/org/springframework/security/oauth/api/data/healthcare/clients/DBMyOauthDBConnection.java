	 ...
	 */
	 ...
	 public class DBMyOauthDBConnection {
	 	
	 	
	 	
	 	public static Connection getConnection() {
	 		
	 		String jdbcUrl = "jdbc:mysql://192.180.3.7:3306/oauthdb";
	 		String jdbcUser = "smartauth";
	 		String jdbcPassword = "authclient";
	 		...
	 		if (conn != null) {
	 		    System.out.println("Connected to .7");
	 		}
	 		} catch (Exception e) {
	 		e.printStackTrace();
	 		}
