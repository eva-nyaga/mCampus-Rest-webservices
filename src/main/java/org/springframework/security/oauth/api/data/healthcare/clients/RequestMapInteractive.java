...
public class RequestMapInteractive {
	 ...
	 private String[] DBParams;
	  ...
	  public RequestMapInteractive(String q, String customerid, String country, int startindex,
	  ...
	  public RequestMapInteractive(String customerid, String country, int startindex,
			int maxresults, int status, String restrict, String orderby) {
	  ...
	  public RequestMapInteractive(String customerid, String country) {
